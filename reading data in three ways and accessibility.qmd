...
```{r , boxplots, fig.cap = "Side-by-Side boxplots of pre- and post-test scores", fig.alt = "Side-by-side boxplots of the 3 different groups's difference in pre and post test scores"}
boxpl <- allscores |> 
...
boxpl3 <- allscores |>
  ...
  scale_fill_manual(values=c("white","lightgray","lightpink")) +
...
THEN you can create the same plot as above:
