...
*Note - this document will render but unfortunately won't publish in rpubs*
...
The code for making streamgraphs has changed with new updates to R. You have to download and install Rtools44 from the link, https://cran.rstudio.com/bin/windows/Rtools/. and then used the code provided below.
